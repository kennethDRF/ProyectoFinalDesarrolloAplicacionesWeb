...
-- =====================================================
-- Datos de prueba para Barbex
-- 2 barberias, 1 barbero por barberia, 3 clientes por barberia
-- Servicios variados (con y sin adelanto)
-- Sin citas
-- =====================================================

-- Limpiar tablas (por si se ejecuta sobre datos existentes)
...
-- Usuarios
-- =====================================================
-- Barbero 1 -> Barberia 1
INSERT INTO usuarios (id, email, password, nombre_completo, telefono, rol, activo, barberia_id) VALUES
(1, 'barbero1@barbex.com', '$2b$12$HOFjq5oMsA7oPYkk370JKORbyTHR1KUMFIFqg0jMDKiV1cHvDnIFO', 'Carlos Barbero', '8888-1111', 'BARBERO', true, 1);

-- Barbero 2 -> Barberia 2
INSERT INTO usuarios (id, email, password, nombre_completo, telefono, rol, activo, barberia_id) VALUES
(2, 'barbero2@barbex.com', '$2b$12$HV/pQCaxEx9omVtlAtpl3.6iM6R21qGjuszbwnQbdlRajfKQ/Wwp.', 'Diego Estilista', '8888-5555', 'BARBERO', true, 2);

-- Clientes Barberia 1
INSERT INTO usuarios (id, email, password, nombre_completo, telefono, rol, activo, barberia_id) VALUES
(3, 'cliente1@barbex.com', '$2b$12$lnWWVQo3zJcDZv9GmGxaeerykxsmwLlgtQPiETGwaZrLgYBbHfwum', 'Ana Lopez', '8888-2222', 'CLIENTE', true, 1),
(4, 'cliente2@barbex.com', '$2b$12$tdkX98hRlHKLljT8MoMDx.0tlZm5EkG6p.YSTBYD7GYDpcN1q4ILy', 'Luis Mora', '8888-3333', 'CLIENTE', true, 1),
(5, 'cliente3@barbex.com', '$2b$12$8X8icvKdVtw/BxeelFK93O9fJmUGwJn3.QKoGOQw7uhw87BodagP6', 'Maria Soto', '8888-4444', 'CLIENTE', true, 1);

-- Clientes Barberia 2
INSERT INTO usuarios (id, email, password, nombre_completo, telefono, rol, activo, barberia_id) VALUES
(6, 'cliente4@barbex.com', '$2b$12$UfAj8eFrqnSx8BWC800Rh.eZS5lMnQbSNbuOieJd8XJlmiu3M8sqe', 'Sofia Rojas', '8888-6666', 'CLIENTE', true, 2),
(7, 'cliente5@barbex.com', '$2b$12$rcx/NZLIC3oq6qmfxC.lYObEPkThf.4lC2lbcyB/Hw8ORi3c02qpm', 'Pedro Vega', '8888-7777', 'CLIENTE', true, 2),
(8, 'cliente6@barbex.com', '$2b$12$MTCN08DJYzoBhB.ZpzqEneOE7cRPAcQTRoj2fJ3H8iqGhXjaE0fAm', 'Elena Cruz', '8888-8888', 'CLIENTE', true, 2);
...
-- =====================================================
-- Servicios Barberia 2 (distintos)
-- =====================================================
INSERT INTO servicios (id, nombre, descripcion, precio, duracion_minutos, monto_adelanto, activo, barberia_id) VALUES
...
-- =====================================================
-- Asignacion de servicios a barberos
-- =====================================================
...
-- =====================================================
-- Horarios generales de los barberos
...
-- Ajustar AUTO_INCREMENT para que los nuevos registros continuen correctamente
