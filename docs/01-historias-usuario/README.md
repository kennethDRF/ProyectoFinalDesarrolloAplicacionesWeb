...
| Rol | Descripción |
|---|---|
| **Cliente** | Solicita servicios y agenda citas. |
| **Barbero/Empleado** | Atiende citas y registra servicios realizados. |
| **Recepcionista** | Gestiona clientes, citas y pagos. |
| **Administrador** | Gestión general: usuarios, empleados, servicios y reportes. |